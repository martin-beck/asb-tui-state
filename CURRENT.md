...
| P1 | [AR-1198](tasks/AR-1198-help-catalog-ci-hardening.md): Contextual-help catalog CI hardening | Make document-backed contextual help complete, meaningful, privacy-safe, and continuously enforced by CI. | Independently review PR #88 at exact head, then verify it against the complete UI element/action inventory and the formal model before promotion. | root-ar-tui-registry |

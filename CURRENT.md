...
| P0 | [AR-0002](tasks/AR-0002.md): Operationalize asb-tui agent coordination | Operationalize the Git-backed coordinator without disrupting existing asb-tui work. | Reconfirm independent review and exact-head hosted state CI after raising the formal public-runner timeout; product PR #24 remains green. Do not merge. | codex-asb-tui-coordinator-ops-20260913 |

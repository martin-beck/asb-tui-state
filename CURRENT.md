...
| P0 | [AR-0002](tasks/AR-0002.md): Operationalize asb-tui agent coordination | Operationalize the Git-backed coordinator without disrupting existing asb-tui work. | Wait for pre-existing asb-tui agents to finish and reconcile their durable work before claiming. | codex-asb-tui-coordinator-ops-20260913 |

...
| --- | --- | --- | --- | --- |
| P0 | [AR-0001](tasks/AR-0001.md): Adopt Agent Workflow Quality v0.32.0 | Adopt AWQ v0.32.0 additively in shadow mode while retaining every native gate. | Authenticate the v0.32.0 release bundle and add the minimal core shadow policy, pinned invocation, provenance, workflow, and focused tests. | codex-asb-tui-awq-v032-20260913 |

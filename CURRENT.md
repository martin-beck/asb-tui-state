...
| --- | --- | --- | --- | --- |
| P0 | [AR-1192](tasks/AR-1192-authenticated-agent-wizard.md): Authenticated agent wizard integration | Consume authenticated ASB agent catalog and lifecycle in the standalone wizard. | Remain blocked until ASB publishes authenticated agent_catalog and lifecycle control methods; ASB AR-1160 remains blocked and its successor AR-1310 is itself blocked by AR-1312/AR-1313. Resume only after exact verified ASB contract heads are published. | - |

...
It vendors the exact `agent-workflow-coordinator` v0.3.5 release and deliberately selects the
tracked Markdown/Git backend. It does not use or create a SQLite authority database.

...
| --- | --- | --- | --- | --- |
| P0 | [AR-1323](tasks/AR-1323-helper-execution-handoff.md): Runner-owned credential-helper execution handoff | codex | Invoke the approved credential helper through the authenticated runner boundary. | Monitor PR #137 at 438db82 and ASB PR #253 at eeeb05b until exact-head checks pass; then rerun live helper invocation and capture first-user wizard connected/unavailable evidence. |

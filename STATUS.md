...
| --- | --- | --- | --- | --- |
| P0 | [AR-1323](tasks/AR-1323-helper-execution-handoff.md): Runner-owned credential-helper execution handoff | codex | Invoke the approved credential helper through the authenticated runner boundary. | Monitor merged TUI PR #137 and ASB PR #253 at 1fb8c0a until exact-head checks pass; then run live helper invocation and capture first-user wizard connected/unavailable evidence. |
